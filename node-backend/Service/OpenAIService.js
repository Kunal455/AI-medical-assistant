...
- "precautions": Array of strings (general wellness advice based on the findings)`;
            ...
            console.error("OpenAI Report Analysis Error:", error.response?.data || error.message);
...
- "description": string (general advice)`;
            ...
            console.error("OpenAI Symptoms Analysis Error:", error.response?.data || error.message);
            throw new Error("Failed to analyze symptoms with OpenAI");
        }
    }
...
(If specific RxNorm ID is unknown, make a reasonable guess or leave it empty).`;
            ...
            console.error("OpenAI Medicine Details Error:", error.response?.data || error.message);
            throw new Error("Failed to get medicine details with OpenAI");
        }
    }
}
