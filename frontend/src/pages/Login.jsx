    ...
    <div className="min-h-screen flex flex-col md:flex-row text-white font-sans">
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center bg-[#09090b] relative p-8 md:p-0 min-h-[60vh] md:min-h-screen">
        <form onSubmit={handleLogin} className="w-full max-w-[400px]">
          ...
          <p className="text-gray-400 mb-8">Sign in to continue your consultations</p>
          ...
          <p className="mt-6 text-center text-gray-400 text-sm">
            No account?{" "}
            <Link to="/register" className="text-[#c13024] hover:text-[#a6251a] font-medium transition-colors">
              Create one
            </Link>
          </p>
        </form>
