  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#090507] text-white font-sans selection:bg-red-500/30">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 md:px-6 relative z-10 text-center mt-8 md:mt-12">
        ...
        {/* Feature Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl w-full mt-16 md:mt-24 mb-16 text-left px-6 md:px-0">
          <div className="bg-[#120a0d] border border-red-900/20 p-6 rounded-2xl">
            ...
            <h3 className="text-[#e87a71] font-semibold text-base mb-1">Symptom guidance</h3>
          ...
          <div className="bg-[#120a0d] border border-red-900/20 p-6 rounded-2xl">
            ...
            <h3 className="text-[#e87a71] font-semibold text-base mb-1">Private by design</h3>
            <p className="text-gray-400 text-xs leading-relaxed">Your conversations stay tied securely to your account.</p>
          </div>
          ...
          <div className="bg-[#120a0d] border border-red-900/20 p-6 rounded-2xl">
            ...
            <h3 className="text-[#e87a71] font-semibold text-base mb-1">Clinician-friendly</h3>
            <p className="text-gray-400 text-xs leading-relaxed">Switch to clinical mode for terminology and depth.</p>
          </div>
        </div>
      </main>
